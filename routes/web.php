...
Route::get('/admin_panel/{any}', 'Admin\AdminPanelController@index');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'namespace'=>'Admin'], function () {
    Route::any('/competition', 'CompetitionController@index');
    Route::any('/competition/getInfo/{id}', 'CompetitionController@getInfo');
    Route::post('/competition/ajaxSaveInfo', 'CompetitionController@ajaxSaveInfo');
    Route::post('/competition/ajaxUpdateInfo', 'CompetitionController@ajaxUpdateInfo');
    Route::post('/competition/ajaxDeleteInfo', 'CompetitionController@ajaxDeleteInfo');
    
    Route::any('/competition/findWinner/{competition_id}', 'CompetitionController@findWinner');
    Route::post('/competition/setWinner', 'CompetitionController@setWinner');

    Route::any('/past', 'PastCompetitionController@index');
    Route::any('/past/info/{id}', 'PastCompetitionController@info');
    Route::post('/past/ajaxUpdateInfo', 'PastCompetitionController@ajaxUpdateInfo');
    Route::any('/past/ajaxDeleteInfo/{id}', 'PastCompetitionController@ajaxDeleteInfo');
});

Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'namespace'=>'Admin'], function () {
    Route::any('/order', 'OrderController@index');
    Route::any('/order/info/{id}', 'OrderController@info');
    Route::post('/order/ajaxSaveInfo', 'OrderController@ajaxSaveInfo');
    Route::post('/dashboard/getChartData', 'DashboardController@getChartData');
    
});

Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'namespace'=>'Admin'], function () {
    Route::any('/promoCode', 'PromoCodeController@index');
    Route::any('/promoCode/info/{id}', 'PromoCodeController@info');
    Route::post('/promoCode/ajaxSaveInfo', 'PromoCodeController@ajaxSaveInfo');
    Route::post('/promoCode/ajaxDeleteInfo', 'PromoCodeController@ajaxDeleteInfo');
...
Route::group(['middleware' => 'user'], function () {
    ...
    Route::post('my-account', 'FrontEndController@update');
    Route::post('update_password', 'FrontEndController@update_password');
...
Route::get('/live-competitions', 'Front\CompetitionController@index');
Route::get('/competition-page/{id}', 'Front\CompetitionController@info');
Route::post('competition/ajaxAvailSelectTicket', 'Front\CompetitionController@ajaxAvailSelectTicket');
Route::post('competition/ajaxInsertBasket', 'Front\CompetitionController@ajaxInsertBasket');
Route::post('competition/ajaxSelectRandTicket', 'Front\CompetitionController@ajaxSelectRandTicket');

Route::get('cart/{id}', "Front\BasketController@cart");
Route::post('basket/deleteCartCompetition', "Front\BasketController@deleteCartCompetition");
Route::any('basket/applyCoupon', "Front\BasketController@applyCoupon");

Route::get('/checkout','Front\BasketController@checkout');
Route::post('order/createOrder', "Front\OrderController@createOrder");
Route::post('order/paySuccess', "Front\OrderController@paySuccess");
Route::get('order/paymentProcess/{order_number}', "Front\OrderController@paymentProcess");
Route::post('order/payCallback', "Front\OrderController@payCallback");
Route::get('order/timeout/{order_number}', "Front\OrderController@timeout");
Route::get('/past', 'Front\PastCompetitionController@index');

//Route::get('/competition-page', function () {  return view('front.competition-page');});
Route::get('/forgot-password', function () {  return view('front.forgot-password');});

Route::get('/order-details/{id}',"Front\OrderController@orderDetails");
