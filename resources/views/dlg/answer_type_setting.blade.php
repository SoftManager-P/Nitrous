<div class="modal fade bs-example-modal-sm in" id="answerTypeSettingDlg" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Answer Type Setting Dialog</h4>
            </div>
...
<script>
    ...
    function genTextItem(answerCount){
        var html = `<div class = "form-group row">
                    ...
                    &nbsp;
                    <a href = "javascript:void(0)" onclick = "removeAnswer(this)">Remove</a>
                    </div>
                    </div>`;
        return html;
    }
