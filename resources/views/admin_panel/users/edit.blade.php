        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 header-title"> Editing user : <span class="user_name_max">{!! $user->first_name!!} {!! $user->last_name!!}</span></h4>
                        <!--main content-->
                                ...
                                <div id="rootwizard">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
                                            ...
                                            <div class="form-group  row {{ $errors->first('group', 'has-error') }}">
                                            ...
                                            <p class="text-warning form-group row">If you don't want to change password... please leave them empty</p>
                                        ...
                                        <ul class="pager wizard">
                                            <li class="next finish-btn"><a href="javascript:;">Finish</a></li>
                                        </ul>
                                    </div>
                                </div>
                                </form>
