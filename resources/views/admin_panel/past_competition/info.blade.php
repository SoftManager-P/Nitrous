                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" id = "infoForm" action="{{url("admin/competition/ajaxUpdateInfo")}}" method = "post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <img id = "photoImg_img"  ratio = "1.6" class = "photoImg "  style = "width:100%;" @if($info['photo']!= '') src = "{{correctImgPath1($info['photo'])}}" @endif/>
                                    <input type = "hidden" class = "photoImgData" id = "photoImg_val" value = "@if($info['photo'] != ''){{$info['photo']}}  @endif" />
                                    <div class = "@if($info['photo'] == '') hidden @endif delBtnWrapper">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input name="draw_video_url" type="text" placeholder="Draw Video Url" class="form-control" value = "{{$info['draw_video_url']}}"></div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 control-label" for="name">Delivery Video Ur1</label>
                                <div class="col-md-9">
                                    <input name="delivery_video_ur1" type="text" placeholder="Delivery Video Ur1" class="form-control" value = "{{$info['delivery_video_ur1']}}"></div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 control-label" for="name">Winner User Name</label>
                                <div class="col-md-9">
                                    <input name="winner_user_name" type="text" placeholder="Winner User Name" class="form-control" value = "{{$info['winner_user_name']}}"></div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 control-label" for="name">Ticket Number</label>
                                <div class="col-md-9">
                                    <input name="ticket_number" type="text" placeholder="Ticket Number" class="form-control" value = "{{$info['ticket_number']}}"></div>
                            </div>
