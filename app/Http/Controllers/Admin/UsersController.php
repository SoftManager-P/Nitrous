...
class UsersController extends JoshController
{
    ...
    public function data(Request $request)
    {
        ...
        })->get(['users.id', 'users.first_name', 'users.last_name', 'users.email','users.created_at', 'role_users.role_id', 'users.is_active']);
        ...
        return DataTables::of($users)
            ...
            ->addColumn('actions',function($user) {
                $actions = '<a href='. route('admin.users.show', $user->id) .'><i class="ti-eye" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view user"></i></a>
                            <a href='. route('admin.users.edit', $user->id) .'><i class="ti-pencil" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update user"></i></a>';
                ...
                if ((Sentinel::getUser()->id != $user->id) && ($user->id != 1)) {
                    ...
                    $actions .= '<a href='. route('admin.users.confirm-delete', $user->id) .' data-toggle="modal" data-target="#delete_confirm"><i class="ti-trash" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete user"></i></a>';
    ...
    public function create()
    {
        ...
        // Show the page
        return view('admin_panel.users.create', compact('groups', 'countries'));
    }
    ...
    public function edit(User $user)
    {
        ...
        // Show the page
        return view('admin_panel.users.edit', compact('user', 'roles', 'userRoles', 'countries', 'status'));
    }
    ...
    public function getDeletedUsers()
    {
        ...
        // Show the page
        return view('admin_panel.users.deleted_users', compact('users'));
    }
    ...
    public function getModalDelete($id)
    {
        ...
        try {
            ...
            if ($user->id === Sentinel::getUser()->id) {
                ...
                return view('admin_panel.layouts.modal_confirmation', compact('error', 'model', 'confirm_route'));
            }
        } catch (UserNotFoundException $e) {
            // Prepare the error message
            $error = trans('users/message.user_not_found', compact('id'));
    ...
    public function getRestore($id)
    {
        ...
        try {
            ...
            // Redirect to the user management page
            return Redirect::route('admin_panel.deleted_users')->with('error', $error);
        }
    }
